...
/**
 The base class for all NCCA15 modules
 */
...
/**
 NCCA15 Platform calls this method on startup.
 */
-(void)startup;

/**
 NCCA15 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 NCCA15 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 NCCA15 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 NCCA15 Platform calls this method on resume.
 @param sender The sender of the event.
 */
