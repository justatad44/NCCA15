...
// in simulator we redefine to format for NCCA15 Developer console
...
{\
	NSString * exceptionName = [@"org.ncca15." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ncca15";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINCCA15NativeItemNone = -1, 
	UINCCA15NativeItemSpinner = -2,
	UINCCA15NativeItemProgressBar = -3,
	
	UINCCA15NativeItemSlider = -4,
	UINCCA15NativeItemSwitch = -5,
	UINCCA15NativeItemMultiButton = -6,
	UINCCA15NativeItemSegmented = -7,
	
	UINCCA15NativeItemTextView = -8,
	UINCCA15NativeItemTextField = -9,
	UINCCA15NativeItemSearchBar = -10,
	
	UINCCA15NativeItemPicker = -11,
	UINCCA15NativeItemDatePicker = -12,
	
	UINCCA15NativeItemInfoLight = -13,
	UINCCA15NativeItemInfoDark = -14,
	
	UINCCA15NativeItemDisclosure = -15,
	
	UINCCA15NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NCCA15 instances of
