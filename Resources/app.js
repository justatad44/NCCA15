...
Ti.include('ui/common/GlobalFunctions.js');
Ti.include('ui/common/FormFunctions.js');
Ti.include('ui/common/DataFunctions.js');

//make dictionaries
//Ti.App.gl_formNameDict = openFormNameDict();
